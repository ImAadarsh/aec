        ...
        <div class="container">
            <div class="row">
                <div class="title-style-two center">
                    <span class="bg-content">Core Pillars</span>
                    <span class="pre">Our Foundation</span>
                    <h2 class="title rts-text-anime-style-1">The AEC Charter</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
