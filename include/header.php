                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-top-one-wrapper">
                            <div class="left">
                                <div class="mail">
                                    <a href="mailto:info@asianeducationcoalition.org"><i class="fal fa-envelope"></i>
                                        info@asianeducationcoalition.org</a>
                                </div>
                            ...
                            <div class="right">
                                ...
                                <ul class="social-wrapper-one">
                                    ...
                                    <li><a class="mr--0" href="#"><i class="fab fa-youtube"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-main-one-wrapper">
                            <div class="thumbnail">
                                <a href="index.php">
                                    <img src="aec.svg" alt="finbiz-logo">
                                </a>
                            </div>
