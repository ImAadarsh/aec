                ...
                <div class="col-lg-6">
                    <div class="consultancy-style-one">
                        <div class="title-style-two mb--40 left">
                            ...
                            <h2 class="title rts-text-anime-style-1">Facilitating Strategic Cooperation <br>
                                in School Education
                            </h2>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="title-style-two center">
                    ...
                    <span class="pre">Founding Members</span>
                    <h2 class="title rts-text-anime-style-1">Our Coalition Partners</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
